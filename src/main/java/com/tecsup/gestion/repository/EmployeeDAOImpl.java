...
public class EmployeeDAOImpl implements EmployeeDAO {
	...
	@Override
	public Employee findEmployeeByFirstName(String firstname) throws DAOException, EmptyResultException {
	...
	@Override
	public Employee findEmployeeBySalary(int salary) throws DAOException, EmptyResultException {

		String query = "SELECT employee_id, login, password, first_name, last_name, salary, department_id "
				+ " FROM employees WHERE salary = ?";

		Object[] params = new Object[] { salary };
